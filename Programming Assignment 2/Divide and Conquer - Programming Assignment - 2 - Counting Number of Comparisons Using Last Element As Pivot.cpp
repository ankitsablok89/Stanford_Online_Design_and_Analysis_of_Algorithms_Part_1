...
int partitionArray(double *numbers , int leftIndex , int rightIndex){
    ...
    // as we need to choose the final element of the array as the pivot element we first
    // perform a swap as a pre-processing step
...
int main(){
    ...
    freopen("/home/ankit/Desktop/Coursera Courses/Design and Analysis of Algorithms - Part 1/Programming Assignment 2/QuickSortAnswer2.txt" , "wb", stdout);
